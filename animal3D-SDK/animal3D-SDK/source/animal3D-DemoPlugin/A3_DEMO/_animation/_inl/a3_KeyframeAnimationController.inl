...
inline a3i32 a3clipControllerUpdate(a3_ClipController* clipCtrl, const a3real dt)
{
	...
	//		figure out new kN
	//	-> if negative, keyframeN <- keyframe1 <- keygrame0 <- keyframeP
	//		figure out new kP
...
// evaluate the current value at time. Could pass an Enum for interp type.
inline a3i32 a3clipControllerEvaluate(a3_ClipController const* clipCtrl, a3_Sample* sample_out)
{
	if (clipCtrl && clipCtrl->clipPtr && sample_out)
	{
		...
		*sample_out = clipCtrl->keyframeParam < 0.5
